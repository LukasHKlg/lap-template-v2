...
namespace OnlineShop.ApiService.Migrations
{
    ...
    [Migration("20250325111118_addOrderDateToSalesOrder")]
    partial class addOrderDateToSalesOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnlineShop.ApiService.Models.SalesOrder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CartId = 1,
                            CustomerId = 4,
                            OrderDate = new DateTime(2025, 3, 25, 12, 11, 17, 894, DateTimeKind.Local).AddTicks(3858),
                            ShippingAddressId = 1
                        });
                });
